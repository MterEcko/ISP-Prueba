...
module.exports = function(app) {
  ...
  app.put('/api/chat/conversations/:id', [authJwt.verifyToken], chatController.updateConversation);
  app.delete('/api/chat/conversations/:id', [authJwt.verifyToken], chatController.deleteConversation);

  // === MENSAJES ===
  app.post('/api/chat/messages', [authJwt.verifyToken], chatController.sendMessage);
  app.put('/api/chat/messages/:id', [authJwt.verifyToken], chatController.updateMessage);
  app.delete('/api/chat/messages/:id', [authJwt.verifyToken], chatController.deleteMessage);
