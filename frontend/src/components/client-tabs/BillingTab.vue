        ...
        <div class="section-content">
          ...
          <div v-else-if="billingInfo" class="billing-summary">
            <div class="summary-grid">
              ...
              <div class="summary-item">
                <span class="summary-label">D��a de Facturaci��n</span>
              ...
              <div class="summary-item">
                <span class="summary-label">D��as de Gracia</span>
                <span class="summary-value">
                  {{ billingInfo.graceDays || 0 }} d��as
                </span>
              </div>
          ...
          <div v-else class="stats-grid">
            ...
            <div class="stat-item">
              ...
              <div class="stat-info">
                ...
                <div class="stat-label">D��as Promedio de Retraso</div>
              </div>
            </div>
  ...
  methods: {
    ...
    async loadRecentPayments() {
      ...
      try {
        ...
        console.log('?? Datos extra��dos:', paymentsData);
    ...
    async loadStats() {
      ...
      try {
        console.log('?? Calculando estad��sticas b��sicas');
        ...
        try {
          ...
          console.warn('?? No se pudieron cargar todos los pagos para estad��sticas:', error);
        }
...
totalInvoices: this.clientInvoices.length,
        ...
        console.log('? Estad��sticas calculadas:', this.billingStats);
    ...
    async sendInvoiceByEmail(invoice) {
      try {
        this.$emit('show-notification', 'Funcionalidad de env��o por email en desarrollo', 'info');
      } catch (error) {
