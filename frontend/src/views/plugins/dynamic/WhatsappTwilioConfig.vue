...
export default {
  ...
  methods: {
    async loadConfig() {
      try {
        const response = await api.get('/plugins/whatsapp-twilio/config');
    ...
    async loadStatus() {
      try {
        const response = await api.get('/plugins/whatsapp-twilio/status');
    ...
    async saveConfig() {
      ...
      this.saving = true;
      try {
        await api.post('/plugins/whatsapp-twilio/config', this.config);
